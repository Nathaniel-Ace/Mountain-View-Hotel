                        ...
                        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                            <div class="card" style="border-radius: 15px; background-color: #bacec1">
                                <div class="card-body p-4">
                                    <h2 class="text-center mb-1 fw-bold">Liste aller Reservierungen</h2>

                                        <div class="d-flex justify-content-center">
                                            <div class="form-outline mb-3 fw-bold">
                                                <table>
                                                    <tr>
                                                        <th height ="35" width ="50"><u>RID</u></th>
                                                        <th width ="150"><u>Benutzername</u></th>
                                                        <th width ="150"><u>Zeitpunkt der Reservierung</u></th>
                                                    </tr>
                                                    <?php
                                                        ...
                                                        while($row = $result->fetch_assoc()) { // Liste aller Reservierungen, die von allen Usern gemacht wurden
                                                            echo "<tr>";
                                                            echo "<td><a href='reservation_detail.php?RID=" . $row['RID'] . "'>" . $row['RID'] . "</a></td>";
